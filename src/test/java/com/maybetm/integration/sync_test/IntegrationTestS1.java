...
import com.maybetm.configuration.DBInitData;
...
public class IntegrationTestS1 extends AITest {
	...
	@Before
	public void proxy() throws SQLException {
		new DBInitData(url).execute();
	}
...
/*	@Test
	public void testCaseForMarket() throws Exception {
		logger.info("testtesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttesttest");
	}*/
}
