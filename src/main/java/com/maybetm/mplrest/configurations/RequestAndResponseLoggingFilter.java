...
public class RequestAndResponseLoggingFilter extends OncePerRequestFilter {
  ...
  protected void requestLogging(ContentCachingRequestWrapper request, ContentCachingResponseWrapper response) {
    val prefix = "Request from: " + request.getRemoteAddr() + ":" + request.getLocalPort() + "|>";
  ...
  private static void logRequestHeader(ContentCachingRequestWrapper request, String prefix) {
    ...
    log.info("{} : {}", prefix, getHeaders.apply(request));
  }

  // преобразуем входящие хидеры в строку для логгирования
  private static final Function<ContentCachingRequestWrapper, String> getHeaders = (request) -> {
